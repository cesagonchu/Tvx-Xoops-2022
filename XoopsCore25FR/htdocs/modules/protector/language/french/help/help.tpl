<div id="help-template" class="outer">
    <h1 class="head">Aide : <a class="ui-corner-all tooltip" href="<{$xoops_url}>/modules/protector/admin/index.php" title="Retour à l'administration de Protector"> Protector <img src="<{xoAdminIcons home.png}>" alt="Retour à l'administration de Protector"/></a></h1>
    <!-- -----Contenu de l'aide ---------- -->
    <h4 class="odd">Description</h4>

    <p class="even">Protector est un module qui défend votre CMS XOOPS contre diverses attaques malveillantes.</p>
    <h4 class="odd">Installation / Désinstallation</h4>

    <p>Tout d'abord, définissez XOOPS_TRUST_PATH dans mainfile.php si vous ne l'avez jamais encore fait.</p>
    <br>

    <p>Copiez le dossier html/modules/protector contenu dans l'archive vers XOOPS_ROOT_PATH/modules/</p>

    <p>Copiez le dossier xoops_trust_path/modules/protector contenu dans l'archive vers votre XOOPS_TRUST_PATH/modules/</p>
    <br>

    <p>Donnez la permission d'écriture sur le fichier XOOPS_TRUST_PATH/modules/protector/configs</p>
    ...
    <h4 class="odd">Introduction aux filtres-plugins dans cette archive.</h4>
    ...
    <p>- postcommon_post_htmlpurify4guest.php
        <br>
        Toutes les données envoyées par les invités seront purifiées par HTMLPurifier.
        <br>
        Si vous autorisez les invités à publier du HTML, je vous recommande vivement de l'activer.
    </p>
...
<p class="even">Tutoriel à venir bientôt.</p>
    <!-- -----Contenu de l'aide ---------- -->
</div>