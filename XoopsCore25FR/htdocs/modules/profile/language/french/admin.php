...
define('_PROFILE_AM_UNICODE_URL', 'Lien unicode');
...
define('_PROFILE_AM_PROF_EDITABLE', 'Champ modifiable à partir du profil');
...
define('_PROFILE_AM_FIELDVISIBLEON', 'visualiser un profil de');
...
define('_PROFILE_AM_KEY', 'Valeur à enregistrer');
define('_PROFILE_AM_VALUE', 'Texte à afficher');
// User management
define('_PROFILE_AM_EDITUSER', 'Modifier l\'utilisateur');
define('_PROFILE_AM_SELECTUSER', 'Sélectionner un utilisateur');
...
define('_PROFILE_MA_USERLEVEL', 'Niveau de l\'utilisateur');
...
define('_PROFILE_AM_USER_ACTIVATED', 'Activé par l\'utilisateur');
define('_PROFILE_AM_USER_DEACTIVATED', 'Utilisateur désactivé');
define('_PROFILE_AM_USER_NOT_ACTIVATED', 'Erreur : utilisateur non activé');
...
//1.63
define('_PROFILE_AM_REQUIRED_TOGGLE', 'Basculer vers le champ obligatoire');
define('_PROFILE_AM_REQUIRED_TOGGLE_SUCCESS', 'Champ obligatoire modifié avec succès');
define('_PROFILE_AM_REQUIRED_TOGGLE_FAILED', 'Échec de la modification du champ obligatoire');
define('_PROFILE_AM_SAVESTEP_TOGGLE', 'Basculer vers l\'enregistrement');
define('_PROFILE_AM_SAVESTEP_TOGGLE_SUCCESS', 'Modification réussie de l\'enregistrement après l\'étape');
define('_PROFILE_AM_SAVESTEP_TOGGLE_FAILED', "Échec de la modification de « enregistrer après l'étape »");
//XOOPS 2.5.9
define('_PROFILE_AM_CANNOTDEACTIVATEWEBMASTERS', 'Vous ne pouvez pas désactiver le compte Administrateur');
