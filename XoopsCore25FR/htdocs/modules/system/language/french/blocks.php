...
define('_MB_SYSTEM_EACNT', 'Modifier son compte');
// RMV-NOTIFY
...
define('_MB_SYSTEM_LOGO', 'L\'image du logo se trouve dans le répertoire %s');  // %s is your root image directory name
define('_MB_SYSTEM_COMPEND', 'Commentaires');
//define('_MB_SYSTEM_LOGGEDINAS',"Connecté en tant que");
define('_MB_SYSTEM_SADMIN', 'Montrer les groupes d\'administration ');
define('_MB_SYSTEM_SPMTO', 'Envoyer un message privé à %s');
define('_MB_SYSTEM_SEMTO', 'Envoyer un courriel à %s');
define('_MB_SYSTEM_DISPLAY', 'Afficher les %s membres');
...
define('_MB_SYSTEM_THWIDTH', 'Largeur de la capture d\'image');
