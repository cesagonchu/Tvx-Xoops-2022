...
define('_AM_PROTECTOR_UPDATED', 'Mise à jour');
define('_AM_PROTECTOR_COPY', 'Copier');
define('_AM_PROTECTOR_ACTIONS', 'Actions');
// XOOPS 2.5.10 v Protector 3.60
define('_AM_LABEL_BAN_BY_IP', 'Interdire les adresses IP sur les enregistrements vérifiés :');
define('_AM_BUTTON_BAN_BY_IP', 'IP Bannie !');
