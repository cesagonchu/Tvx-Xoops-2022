...
define('XOOPS_PATHS', 'Chemins d\'accès physiques de XOOPS');
define('XOOPS_URLS', 'Adresse du site internet');
define('XOOPS_ROOT_PATH_LABEL', 'Chemin physique de la racine des fichiers XOOPS');
define('XOOPS_ROOT_PATH_HELP', 'Chemin physique vers le répertoire des fichiers XOOPS ( utilisés ) SANS barre oblique de fin de ligne.');
define('XOOPS_LIB_PATH_LABEL', 'Répertoire de la bibliothèque de XOOPS');
define('XOOPS_LIB_PATH_HELP', 'Chemin d\'accès physique au répertoire de la bibliothèque XOOPS SANS barre oblique, pour des raisons de compatibilité. Placez le dossier hors de ' . XOOPS_ROOT_PATH_LABEL . ' pour le sécuriser.');
define('XOOPS_DATA_PATH_LABEL', 'Répertoire des fichiers de données de XOOPS');
define('XOOPS_DATA_PATH_HELP', 'Chemin d\'accès physique au répertoire des fichiers de données (inscriptibles) de XOOPS SANS barre oblique de fin, pour des raisons de compatibilité. Placez le dossier hors de ' . XOOPS_ROOT_PATH_LABEL . ' pour le sécuriser.');
define('XOOPS_URL_LABEL', 'Adresse avec laquelle on accèdera à votre site web (URL)'); // L56
define('XOOPS_URL_HELP', 'Adresse internet principale qui sera utilisée pour accéder à votre installation XOOPS'); // L58
...
define('DB_HOST_HELP', 'Nom d\'hôte du serveur de base de données. Si vous n\'êtes pas sûr, <em>localhost</em> fonctionne dans les situations les plus courantes'); // L67
...
define('DB_CHARSET_LABEL', 'Jeu de caractères pour la base de données');
define('DB_CHARSET_HELP', 'MySQL inclut le support des jeux de caractères qui vous permet de stocker des données en utilisant une variété de jeux de caractères et d\'effectuer des comparaisons selon une variété de collations.');
define('DB_COLLATION_LABEL', 'Collation de la base de données');
define('DB_COLLATION_HELP', 'Une collation est un ensemble de règles permettant de comparer les caractères dans un jeu de caractères.');
define('DB_PREFIX_LABEL', 'Préfixe des tables');    // L30
define('DB_PREFIX_HELP', 'Ce préfixe sera ajouté à toutes les nouvelles tables créées pour éviter les conflits de noms dans la base de données. Si vous n\'êtes pas sûr, gardez simplement le préfixe par défaut.'); // L63
...
define('ADMIN_EMAIL_LABEL', 'Courriel Administrateur'); // L38
...
//define('READY_CREATE_TABLES', 'Aucune table XOOPS détectée.<br>Le programme d\'installation est maintenant prêt à créer les tables système XOOPS.');
...
define('TABLE_CREATED', '%s créée.'); // L45
define('ROWS_INSERTED', '%d entrées insérées dans la table %s.'); // L119
define('ROWS_FAILED', 'Échec d\'insertion des entrées %d dans la table %s.'); // L120
...
// Error messages
define('ERR_COULD_NOT_ACCESS', 'Impossibilité d\'accéder au dossier. Verifiez qu\'il existe et qu\'il est ouvert en écriture sur le serveur.');
define('ERR_NO_XOOPS_FOUND', 'Aucune installation de XOOPS n\'a pu être trouvée dans le dossier spécifié.');
...
define('ERR_NEED_WRITE_ACCESS', '<br>Le serveur doit disposer de droits des permissions en écriture sur les dossiers et fichiers<br />(exemple <em>chmod 775</em> sur un serveur UNIX / LINUX)<br />S\'ils ne sont pas disponibles ou n\'ont pas été créés correctement, veuillez les créer manuellement et définir les autorisations appropriées.');
...
define('ERR_COPY_MAINFILE', 'Impossible de copier le fichier de distribution sur %s');
...
define('ERR_READ_MAINFILE', 'Impossible d\'ouvrir en lecture %s');
define('ERR_INVALID_DBCHARSET', "Le jeu de caractères '%s' n'est pas supporté.");
define('ERR_INVALID_DBCOLLATION', "La collation '%s' n'est pas prise en charge.");
...
//2.5.9
define("CURL_HTTP", "Bibliothèque de liens du client (cURL)");
define('XOOPS_COOKIE_DOMAIN_LABEL', 'Domaine des cookies pour le site');
